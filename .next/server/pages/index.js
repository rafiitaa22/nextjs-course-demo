...
async function getStaticProps() {
  ...
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://admin:IsLPRTCcp0SSDrvP@cluster0.38wvapm.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
